...
class HTMLPurifier_HTMLModule_Tidy extends HTMLPurifier_HTMLModule
{
     ...
     * Index zero is a special cas "no fixes" level.
     * @type array
     */
    ...
    /**
     * Populates the module with transforms and other special-cas code
    ...
    public function getFixType($name)
    {
        ...
        // special cas: attribute transform
        if (!is_null($attr)) {
            if (is_null($property)) {
                $property = 'pre';
            }
