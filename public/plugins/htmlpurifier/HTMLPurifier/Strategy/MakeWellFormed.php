...
class HTMLPurifier_Strategy_MakeWellFormed extends HTMLPurifier_Strategy
{
    ...
    public function execute($tokens, $config, $context)
    {
        ...
        unset($injectors['Custom']); // special cas
        ...
        for (;;
            ...
            // first, check for the simplest cas: everything closes neatly.
...
// defined, and in any cas you probably wanted to operate on trees,
// not token streams.
